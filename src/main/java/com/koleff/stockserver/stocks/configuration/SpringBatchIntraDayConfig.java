...
//@Bean
//public MultiResourceItemWriter<EndOfDay> multiResourceItemWriter(){
//    return new MultiResourceItemWriter<EndOfDay>();
//}
//
//    @Bean
//    public FlatFileItemReader<EndOfDay> flatFileItemReader() {
//        return new FlatFileItemReaderBuilder<EndOfDay>()
//                .name("eodJsonItemReader")
//                .resource(new FileSystemResource("persons.csv"))
//                .delimited()
//                .names("id", "name")
//                .targetType(EndOfDay.class)
//                .build();
//    }
//
//    @Bean
...
//
//    @Bean
//    protected JsonItemReader jsonItemReader() {
//        return new JsonItemReaderBuilder<EndOfDay>()
//                .jsonObjectReader(new GsonJsonObjectReader<>(EndOfDay.class))
//                .resource(new ClassPathResource("*.json")) //TOOD: for the whole directory
//                .name("eodJsonItemReader")
//                .build();
//    }
//
//    @Bean
//    protected JsonFileItemWriter jsonFileItemWriter() {
